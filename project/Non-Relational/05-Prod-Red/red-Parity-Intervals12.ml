...
let reduce (p, i) =
if (Avalues1.eq p (Avalues1.bot ())) then ((Avalues1.bot ()), (Avalues2.bot ()))
else if (Avalues1.eq p (Avalues1.f_NAT "1")) then (p, (reduce_odd i))
else if (Avalues1.eq p (Avalues1.f_NAT "0")) then (p, (reduce_even i))
else if ((Avalues2.parity i) = 0) then ((Avalues1.f_NAT "0"), i) 
else if ((Avalues2.parity i) = 1) then ((Avalues1.f_NAT "1"), i) 
else (p, i)